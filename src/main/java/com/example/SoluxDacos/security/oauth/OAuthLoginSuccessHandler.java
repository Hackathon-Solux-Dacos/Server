...
import com.example.SoluxDacos.domain.RefreshToken;
import com.example.SoluxDacos.domain.User;
import com.example.SoluxDacos.repository.RefreshTokenRepository;
...
public class OAuthLoginSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    @Value("http://3.37.217.36:8081/login?name=%s&access_token=%s&refresh_token=%s")
